<form action="{{ route('tags.index') }}" class="flex items-center">
    <label for="simple-search" class="sr-only">Search</label>
    <div class="relative w-center">
        <div class="absolute inset-y-0 left-0 right-20 flex items-center  pl-3 pointer-events-none">
    ...
    <button type="submit"
        class="p-2.5 ml-2 text-sm font-medium mt-2 text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
